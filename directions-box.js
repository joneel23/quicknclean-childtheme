...
jQuery(function($) {
    ...
    $(document.body).on("click", ".quick_wpgmza_gd, .wpgmza-directions-button", function(event) {
        ...
        //address = '3525 Alta Mere Dr, Fort Worth, TX, USA';
        //address = marker.address;
        //coords = marker.getPosition().toString();

        window.open(map.getExternalURL({marker: marker}));
